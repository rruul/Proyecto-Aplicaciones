<?php
    ...
    $sqlmaes = "SELECT * FROM maestro";
    $resmae = $conn->query($sqlmaes);
?>
    ...
    <main>
            ...
            <div class="container">
                <div class="cabeceratop">
                    ...
                    <div class="nuevocurso">
                        ...
                        <?php include './back/admin/registrocurso.php'?>
                    </div>
                </div>
        ...
        <div class="modal fade" id="registrarcurso" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    ...
                    <label class="form-label" for="maestros">Elige un maestro para el curso</label>
                    <select id="cars" name="maestros" class="form-control" onfocus='this.size=3;' onblur='this.size=1;' onchange='this.size=1; this.blur();'>
                        <?php while($mae=mysqli_fetch_array($resmae)){ ?>
                            <option value="<?php echo $mae['id']?>"><?php echo $mae['nombre'].' '.$mae['apaterno'].' '.$mae['amaterno']?></option>
                        <?php } ?>
                    </select>
                </div>
        ...
        <template id="cardcursos">
            <div class="stylecardcursos">
                ...
                <form action="./adminalumnos.php" method="post">
